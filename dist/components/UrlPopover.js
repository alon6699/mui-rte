...
var PREFIX = 'UrlPopover';
var classes = {
    linkPopover: "".concat(PREFIX, "-linkPopover"),
    linkTextField: "".concat(PREFIX, "-linkTextField")
};
var StyledPopover = (0, material_1.styled)(Popover_1.default)(function (_a) {
    var _b;
    var theme = _a.theme;
    return (_b = {},
        _b["& .".concat(classes.linkPopover)] = {
            padding: theme.spacing(2, 2, 2, 2),
            maxWidth: 250
        },
        _b["& .".concat(classes.linkTextField)] = {
            width: '100%'
        },
        _b);
});
var UrlPopover = function (props) {
    ...
    return (react_1.default.createElement(StyledPopover, { open: props.anchor !== undefined, anchorEl: props.anchor, anchorOrigin: {
            vertical: "bottom",
            horizontal: "left"
        }, transformOrigin: {
            vertical: 'top',
