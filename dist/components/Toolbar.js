...
var Toolbar = function (props) {
    ...
    return (react_1.default.createElement("div", { id: "".concat(props.id).concat(id), className: props.className }, availableControls.map(function (style) {
        if (props.inlineMode &&
